...
if(isset($_POST['save_btn']))
{
    ...
    { 
        ...
        {
            $query = "INSERT INTO student(stud_name,father_name,mother_name,gender,dob,User_email,u_password,Phone_no,u_address,hobbies,languages,stud_image)
            VALUE  ('$name','$father','$mother','$gender_box','$dobs','$email','$user_pass','$ph_no','$add','$hobbstr','$lang','$image')";
            ...
            if($query_run)
            {
                ...
                ?>
                <!-- <meta http-equiv="Refresh" content="3; url='http://localhost/semple_profile/08_delete%20image%20from%20folder%20with%20data%20from%20database/index.php'" /> -->
                <?php
                header('location: form.php');   //use nhi kar na hai
