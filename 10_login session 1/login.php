...
if(isset($_POST['login_fm']))
{
  ...
  if($result == 1)
  {
    ...
    ?>
    <meta http-equiv="Refresh" content="1; url='http://localhost/semple_profile/08_delete%20image%20from%20folder%20with%20data%20from%20database/index.php'" /> 
...
<form class="form-signin" action="login.php" method="POST">
  ...
  <div class="form-label-group">
    ...
    <input type="password" id="inputPassword" class="form-control" name="u_password" placeholder="Password" required>
    <label for="inputPassword">Password</label>
  </div>
  
  <button class="btn btn-lg btn-primary btn-block" type="submit" name="login_fm">Sign in</button>
